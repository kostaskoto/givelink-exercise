      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        {data && (
            ...
            {Object.values(data.products)
              ...
              .map((product: any) => (
                <div key={product.id} className="card hover:bg-sky-50 rounded-lg max-w-[250px] bg-white shadow-lg">
                <Image
                ...
                <h2 className="card-title text-blue-700">{product.name}</h2>
                <p className="card-price text-black">{product.price.toFixed(2)}€</p>
                </div>
                </div>
              ))}
            </div>
